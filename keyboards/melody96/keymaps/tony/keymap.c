...
|        |        |        |        |        |        |        |        |        |        |        |        |        |        |        |        |        |        |   MO   |
| ESC*   |   F1   |   F2   |   F3   |   F4   |   F5   |   F6   |   F7   |   F8   |   F9   |  F10   |  F11   |  F12   |  INS   |  HOME  |   END  |  P UP  | P DOWN |  _FN   |
...
|              |        |        |        |        |        |        |        |        |        |   ;    |   '    |                    |        |        |        |        |
| L CTRL, ESC  |   A    |   S    |   D    |   F    |   G    |   H    |   J    |   K    |   L    |   :    |   "    |       ENTER        |   4    |   5    |   6    |   +    |
...
|          |          |          |                                                        |        |        |        |        |        |        |        |        |        |
|  HYPER   |   LGUI   | L ALT    |                      SPACE                             | R GUI  | R ALT  | R CTRL |  LEFT  |  DOWN  | RIGHT  |   0    |   .    | ENTER  |
...
*/
    ...
    LAYOUT(
    KC_ESC,               KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_INS,  KC_HOME, KC_END,  KC_PGUP, KC_PGDN, MO(1),
    KC_GRV,               KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, KC_DEL,  KC_NLCK, KC_PSLS, KC_PAST, KC_PEQL,
    KC_TAB,               KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,          KC_P7,   KC_P8,   KC_P9,   KC_PMNS,
    MT(MOD_LCTL, KC_ESC), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,                    KC_P4,   KC_P5,   KC_P6,   KC_PPLS,
    KC_LSPO,              KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC,          KC_UP,   KC_P1,   KC_P2,   KC_P3,   KC_PENT,
    HYPR(KC_NO),          KC_LALT, KC_LGUI,                            KC_SPC,                             KC_RGUI, KC_RALT, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT, KC_P0,   KC_PDOT, KC_PENT),
...
*/
    ...
    _______, KC_MPRV, KC_MNXT,                            KC_MPLY,                            _______, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, _______),
};
